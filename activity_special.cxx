...
int main(int argc, char **argv){
  ...
  //  }
  if (argc<3) {
    cerr << " give name of two _cal.root files as argument! first is the sample, the second should be the background file to be subtracted. Also give the calibration file used to get the detector efficienciy information. " << endl;
    return -1;
  }
  ...
  a.ActivityDeterminationSpecial(data1,data2,base,cal);
